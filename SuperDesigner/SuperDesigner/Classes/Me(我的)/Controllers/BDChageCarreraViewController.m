//
//  BDChageCarreraViewController.m
//  SuperDesigner
//
...
@interface BDChageCarreraViewController ()
@property(nonatomic, weak) UIView *backView;
@property(nonatomic, strong) UITextField *textTF;
@end

@implementation BDChageCarreraViewController
...
-(void) clickBtn {
    ...
    NSDictionary *dictParams = @{
                                 @"id": IDNum,
                                 @"vocation" : self.textTF.text
                                 
                                 };
    
    [[BDBaseHttpTool sharedInstance] getWithUrl:url_changeUserJob parameters:dictParams sucess:^(id json) {
