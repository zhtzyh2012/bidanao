//
//  BDChangeWeightViewController.m
//  SuperDesigner
//
...
@interface BDChangeWeightViewController ()
@property(nonatomic, weak) UIView *backView;
@property(nonatomic, strong) UITextField *textTF;
@end

@implementation BDChangeWeightViewController
...
-(void) setUp {
    ...
    textName.placeholder = @"请输入您的体重(kg)";
...
-(void) clickBtn {
    ...
    NSDictionary *dictParams = @{
                                 @"id": IDNum,
                                 @"weight" : self.textTF.text
                                 
                                 };
    
    [[BDBaseHttpTool sharedInstance] getWithUrl:url_changeUserWeight parameters:dictParams sucess:^(id json) {
