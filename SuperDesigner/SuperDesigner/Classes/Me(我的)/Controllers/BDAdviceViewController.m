...
@interface BDAdviceViewController ()<UITextViewDelegate, HXPhotoViewDelegate>
...
@implementation BDAdviceViewController
...
//    UIScrollView *scrollView = [[UIScrollView alloc] initWithFrame:self.view.bounds];
    ...
    scrollView.contentSize = CGSizeMake(KScreen_WIDTH, 1300);
...
//    backView.frame = CGRectMake(0, 15, KScreen_WIDTH,40);
    ...
    [strLengthLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(textV.mas_bottom).offset(-5);
